...
`Prize_4.glb`、`Prize_5.glb`、`Prize_7.glb`、`Prize_8.glb` の高さだけを調整したい場合は、`src/main.js` の `prizeHeightScaleByTypeId` で倍率を変更してください。例えば `7: 1.2` にすると `Prize_7.glb` の高さだけが 1.2 倍になります。
